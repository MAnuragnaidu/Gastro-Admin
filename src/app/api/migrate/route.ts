    ...
    for (const patient of patients) {
      ...
      await prisma.patient.create({
        data: {
          ...
          dateMostRecentColono: patient.dateMostRecentColono || '',
          recentLabValues: patient.recentLabValues || '',
          colonoscopyFindings: patient.colonoscopyFindings || '',
          recentImaging: patient.recentImaging || '',
          mostRecentDexa: patient.mostRecentDexa || '',
